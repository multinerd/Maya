...
namespace Maya.AspNetCore.TagHelpers.Metronic.Controls.Forms
{
    ...
    public class DatepickerTagHelper : MeconsFormTagHelperBase
    {
        ...
        public bool IsWeeksEnabled { get; set; }
        ...
        public DatepickerOrientation Orientation { get; set; } 
        ...
        protected override async Task RenderProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.AddCssClass("form-control m-input date-picker");
            ...
            if (this.Icon != Icon.None)
            {
                ...
                output.PreElement.PrependHtml(str1);
